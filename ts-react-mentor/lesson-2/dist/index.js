...
// // Example array
// const studentArr = ['Name1', 'Name2', 'Name3'];
// function getPropertyArray<T, K extends keyof T>(arr: T, idx: K) {
//   return arr[idx];
// }
// console.log('getPropertyArray(studentArr, 2)', getPropertyArray(studentArr, 2)); // Name3
